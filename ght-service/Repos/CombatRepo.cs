...
namespace GloomhavenTracker.Service.Repos
{
    ...
    public class CombatRepo : ICombatRepo
    {
        ...
        public CombatRepo(IMemoryCache cache) => _cache = cache;
        ...
        public CombatTrackerDO GetCombat(Guid combatId)
        {
            ...
            _cache.TryGetValue<CombatTrackerDO>($"{CACHE_KEYS.Combat}{combatId.ToString()}", out combat);
            return combat;
        }

        public void SaveCombat(CombatTrackerDO combat)
        {
            _cache.Set<CombatTrackerDO>($"{CACHE_KEYS.Combat}{combat.CombatId.ToString()}", combat);
        ...
        private bool CombatIdInListing(Guid combatId)
        {
            if(_combatListing == null)
            {
                ...
                _cache.TryGetValue(CACHE_KEYS.CombatListing, out listingFromMemory);
        ...
        private void AddNewCombatToListing(Guid combatId)
        {
            ...
            _cache.Set<List<Guid>>(CACHE_KEYS.CombatListing, _combatListing);
        }
