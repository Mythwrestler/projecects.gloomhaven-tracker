...
import { combatSpaceId, combatHubConnected, requestCombatSpaceDisconnect, requestCombatSpaceDisconnectSuccess, requestCombatHubConnectionFailure } from "./Store";
import { requestCombatHubConnection, requestCombatHubConnectionSuccess, requestCombatSpaceConnection, requestCombatSpaceConnectionFailure, requestCombatSpaceConnectionSuccess, requestCombatSpaceDisconnectFailure } from ".";

const combatHub: Writable<HubConnection | undefined> = writable<HubConnection | undefined>(undefined)
...
export const buildCombatHub = async (): Promise<void> => {
    ...
    const hub = (ENV_VARS.AUTH.Enabled() && authToken !== '')
