...
export const combatSpaceConnecting: Writable<boolean> = writable<boolean>(false);
...
export const combatSpaces: Writable<CombatSpaceSummary[]> = writable<CombatSpaceSummary[]>([])
export const requestCombatSpaces = (): void => combatSpacesLoading.set(true);
export const requestCombatSpacesSuccess = (spaces: CombatSpaceSummary[]): void => {
    combatSpacesLoading.set(false);
    combatSpaces.set(spaces)
}
export const requestCombatSpacesFailure = (): void => combatSpacesLoading.set(false);
export const requestNewCombatSpaceSuccess = (combatSpace: CombatSpaceSummary): void => combatSpaces.update((spaces: CombatSpaceSummary[]) => [...spaces, combatSpace])
